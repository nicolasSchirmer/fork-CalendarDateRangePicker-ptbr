package com.nicolasschirmer.calendar.customviews;
...
import static com.nicolasschirmer.calendar.customviews.DateRangeCalendarManager.RANGE_TYPE.LAST_DATE;
import static com.nicolasschirmer.calendar.customviews.DateRangeCalendarManager.RANGE_TYPE.MIDDLE_DATE;
import static com.nicolasschirmer.calendar.customviews.DateRangeCalendarManager.RANGE_TYPE.NOT_IN_RANGE;
import static com.nicolasschirmer.calendar.customviews.DateRangeCalendarManager.RANGE_TYPE.START_DATE;
...
class DateRangeCalendarManager {
    ...
    public static SimpleDateFormat SIMPLE_DATE_FORMAT = new SimpleDateFormat(DATE_FORMAT, new Locale("pt", "BR"));
